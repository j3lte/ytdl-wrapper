...
import { isDir, isDirSync, isFile, isFileSync, readDir, readDirSync } from "./fs.ts";
...
export function whichSync(
  ...
  if (WINDOWS) {
    ...
    const pathExtensions = !isNullOrSpace(pe) ? pe?.toLowerCase() : ".com;.exe;.bat;.cmd;.vbs;.vbe;.js;.jse;.wsf;.wsh";
